...
//https://www.bilibili.com/video/BV14r4y1G7h4?p=46&spm_id_from=pageDriver&vd_source=052a4a43fb6ce3b0077fb11d296a0c6e
export const GroupRemove = () => {
  ...
  useEffect(() => {
    ...
    const mesh4 = new THREE.Mesh(geometry1, material2);
