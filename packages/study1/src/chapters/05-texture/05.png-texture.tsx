...
//https://www.bilibili.com/video/BV14r4y1G7h4?p=52&spm_id_from=pageDriver&vd_source=052a4a43fb6ce3b0077fb11d296a0c6e
export const PngTexture = () => {
  ...
  useEffect(() => {
    ...
    const texture = loader.load(arrow);

    const meshMaterial = new THREE.MeshBasicMaterial({
      map: texture,
      side: THREE.DoubleSide,
      transparent: true, //透明部分不显示
    });
