...
//https://www.bilibili.com/video/BV14r4y1G7h4?p=53&spm_id_from=pageDriver&vd_source=052a4a43fb6ce3b0077fb11d296a0c6e
export const UvOffset = () => {
  ...
  useEffect(() => {
    ...
    //创建一个空的几何体
    const geometry = new THREE.PlaneGeometry(260, 60);

    const axesHelper = new THREE.AxesHelper(400);
    scene.add(axesHelper);

    const loader = new THREE.TextureLoader();
    const texture = loader.load(track);
